...
class ColorResources {
  ...
  static const Color DRAWER_ELEMENT_1 = Color(0xffFBDEEE);
  static const Color DRAWER_ELEMENT_2 = Color(0xffD0E9FA);
  static const Color DRAWER_ELEMENT_3 = Color(0xffD2F6EB);

  static const Color SHADOW = Color(0xffDCDCDC);
